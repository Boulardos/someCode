...
contract Alpacadabraz_3D is ERC721A, Ownable {
    ...
    constructor(address _recipient) ERC721("SamuraiCats 3D", "SAMCATS 3D") {
    ...
    function publicMint(uint amount) external payable mintingOpen callerIsUser {
    ...
    function whitelistMint(uint amount, uint totalAllocation, bytes32 leaf, bytes32[] memory proof) external payable mintingOpen callerIsUser{
