contract BrikFarming is Ownable {
    ...
    address public trustedDepositTokenAddress = 0x86966223df02B54eC832E7c24f652Fa882DF6D37;
    address public trustedRewardTokenAddress = 0x11B2Be77cc36AAC04E1AAB2cc99003234DB3Bb42; 

    // Amount of tokens
    uint public disburseAmount = 300000e18; 
    // To be disbursed continuously over this duration
    uint public disburseDuration = 2500 days;
    ...
    uint public minSecTurboStart = 50;
    uint public maxSecTurboStart = 300;
    
    uint public minSecTurboDuration = 60;
    uint public maxSecTurboDuration = 240; 
